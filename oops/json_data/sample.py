...
["jgk","jhnbn","hjbb"]--> json array
"""
import json
json_data = """ ["jgk","jhnbn","hjbb"] """
json_data2 = """ 
{"name":"test","address":"sample address","mobile":"878787"}
 """
json_data3 = """ 
[
{"name":"test","address":"sample address","mobile":"878787"},
{"name":"rest2","address":"sample address675g","mobile":"8787877654"}
]
 """

# json array convert into list using loads
...
# json object convert into dict using loads
tmp = json.loads(json_data2)

print(tmp.get("address"))

for key,val in tmp.items():
    print(key,val)

tmp = json.loads(json_data3)
print(type(tmp))
...
tmp = json.loads(products)
print(type(tmp))
prod_details=[]
for detail in tmp:
    prod_details.append([detail['title'],detail['price'],detail['stock'],detail['rating']])
